...
const ComProjectDetail = ({ projectsinledata }) => {
 ...
 useEffect(() => {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <Overview overview={overview} configuration={configuration} />
...
export default ComProjectDetail;


export async function getServerSideProps({ params }) {
  try {
    // Dispatch the action and await the result
    await store.dispatch(fetchSingleProjects(params?.commercialslug));
