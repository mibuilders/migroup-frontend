...
const Overview = ({ overview }) => {
  ...
  return (
    <>
      {overview && (
        <div className="bg-[#181D23] py-5 lg:py-[5.208vw] overflow-hidden">
          <div className="relative flex flex-col items-center justify-between w-full lg:flex-row lg:min-h-auto">
            ...
            <div className="px-6 lg:px-[7.813vw] flex-1">
              ...
              <div className="lg:my-[12px] relative">
                <div
            ...
            {/* Right Image */}
            <div className="lg:w-[43.75vw] w-full shine lg:h-[36.5vw] flex-1 lg:px-0 px-5 lg:mt-0 mt-[2rem] ">
              {overview?.Image?.data?.length > 0 && (
                <Image
                  src={cleanImage(overview?.Image?.data[0]?.attributes?.url)}
                  alt={
                    overview?.Image?.data[0]?.attributes?.alternativeText
                      ? overview?.Image?.data[0]?.attributes?.alternativeText
                      : "career overview"
                  }
                  width={840}
